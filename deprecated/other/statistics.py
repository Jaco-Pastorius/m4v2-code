...
bagpath = Path('/home/m4pc/m4v2-code/m4_home/m4_ws/rosbag2_2024_05_09-13_08_04')
...
fig, axs = plt.subplots(3,3)
axs[0,0].plot(t_vec[1:],fres[:,0],'r')
axs[1,0].plot(t_vec[1:],fres[:,1],'r')
axs[2,0].plot(t_vec[1:],fres[:,2],'r')
axs[0,1].plot(t_vec[1:],fres[:,6],'r')
axs[1,1].plot(t_vec[1:],fres[:,7],'r')
axs[2,1].plot(t_vec[1:],fres[:,8],'r')
axs[0,2].plot(t_vec[1:],fres[:,5],'r')
axs[1,2].plot(t_vec[1:],fres[:,4],'r')
axs[2,2].plot(t_vec[1:],fres[:,3],'r')
